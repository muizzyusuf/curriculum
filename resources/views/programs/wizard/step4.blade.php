        ...
        <div class="col-md-12">
                ...
                <table class="table table-borderless text-center table-sm" style="table-layout: fixed; width: 100%">
                    <tbody>
                        <tr>
                            ...
                            <td><a class="btn btn-success" href="{{route('programWizard.step4', $program->program_id)}}" style="width: 30px; height: 30px; padding: 6px 0px; border-radius: 15px; text-align: center; font-size: 12px; line-height: 1.42857;"> <b>4</b> </a></td>
            ...
            <div class="card">
                ...
                <div class="card-body">
                        ...
                        <div class="row">
                            <div class="col">
                                <table class="table table-borderless">
                                    ...
                                    @if(count($courses)<1) <tr class="table-active">
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    <button type="button"
                                                        ...
                                                        data-toggle="modal" data-target="#editCourseModal{{$course->course_id}}">
                                                        Edit
                                                    </button>
                                                    <!-- Modal -->
                                                    ...
                                                    <button type="button"
                                                        ...
                                                        data-toggle="modal" data-target="#assignInstructorModal{{$course->course_id}}">
                                                        Instructor
                                                    </button>

                                                    <!-- Modal -->
                                                    <div class="modal fade" id="assignInstructorModal{{$course->course_id}}" tabindex="-1"
                                                        role="dialog" aria-labelledby="assignInstructorModalLabel"
                                                        aria-hidden="true">
                                                        <div class="modal-dialog modal-lg" role="document">
                                                            <div class="modal-content">
                                                                <div class="modal-header">
                                                                ...
                                                                <form method="POST" action="{{route('courses.assign', $course->course_id)}}">
                                                                    ...
                                                                    <form method="POST" action="{{route('courses.assign', $course->course_id)}}">
                                                                        ...
                                                                        <input type="hidden" class="form-input" name="program_id" value={{$course->program_id}}>
                                                                        <button type="submit"  class="btn btn-outline-primary btn-sm" >Assign to self</button>
                                                                    </form>
                                                                    </div>
                                                    ...
                                                    <a href="{{route('courses.status', $course->course_id)}}" >
                                                        <button class="btn btn-outline-primary btn-sm float-right ml-2">Change Status</button></a>
                    ...
                    <div class="row">
                        <div class="col">
                            <button type="button" class="btn btn-primary btn-sm col-2 mt-2 float-right"
                ...
                <div class="card-footer">
                    <a href="{{route('programWizard.step3', $program->program_id)}}"><button
                            class="btn btn-sm btn-primary mt-3 col-3  float-left">⬅ Mapping Scale
                            Outcome</button></a>

                    <a href="{{route('programWizard.step5', $program->program_id)}}"><button
                            class="btn btn-sm btn-primary mt-3 col-3 float-right">Submit ➡</button></a>
                </div>
