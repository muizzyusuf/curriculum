...
Route::resource('/outcomeAssessment','OutcomeAssessmentController');

Route::resource('/outcomeActivity','OutcomeActivityController');
...
Route::get('/programWizard/{program}/step5','ProgramWizardController@step5')->name('programWizard.step5');

Route::get('/courseWizard/{course}/step0','CourseWizardController@step0')->name('courseWizard.step0');
